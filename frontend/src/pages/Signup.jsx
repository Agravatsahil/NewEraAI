      ...
      >
        ...
        >
          <Box sx={{ width: '100%', maxWidth: 520, mx: 'auto', textAlign: 'center' }}>
            ...
            >
              <Box component="form" onSubmit={handleSignup} sx={{ display: 'grid', gap: 1.5 }}>
                <TextField
                  fullWidth
                  name="username"
                ...
                <Typography sx={{ mt: 1.5, textAlign: 'center', color: '#6B7280', fontSize: 13 }}>
                  Already have an account? <Link href="/login" sx={{ color: '#111827', textDecoration: 'underline' }}>Login</Link>
                </Typography>
              </Box>
            </Box>
          </Box>
                ...
                {[
                  ...
                  <Box key={f.title} sx={{ display: 'flex', gap: 1.25, alignItems: 'flex-start' }}>
                    <Box
                      ...
                      src={badge}
                      alt=""
                      sx={{ width: 22, height: 22, flex: '0 0 auto', mt: '2px' }}
                    />
                    <Box>
                ...
                >
                  {reviews.map((r, idx) => (
                    ...
                    >
                      ...
                      <Typography sx={{ mt: 1.25, fontSize: 12.5, fontWeight: 900, color: '#111827' }}>
                        {r.name}
                      </Typography>
                      <Typography sx={{ mt: 0.25, fontSize: 10.5, fontWeight: 700, color: '#6B7280' }}>
                        {r.role}
                      </Typography>
                    </Box>
                  ))}
